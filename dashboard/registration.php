                           ...
                           <div class="p-5">
                              ...
                              <form class="user" method="post" action="action_register.php" >
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <input type="password" class="form-control form-control-user" name="re-password" placeholder="Konfirmasi Kata Sandi" required/>
                                    </div>
                                 </div>
                                 <input type="submit" value="Daftar Akun" class="btn btn-primary btn-user btn-block">
                              </form>
                           </div>
                        </div>
                     </div>
