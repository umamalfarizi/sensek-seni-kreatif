...
/// Mendapatkan data id jenis aksesoris
if ( isset($_GET["id_jenis_aksesoris"]) ) $id = $_GET["id_jenis_aksesoris"];
else echo "id jenis_aksesoris tidak ditemukan! <a href='accessories.php'>Kembali</a>";

$query = "SELECT * FROM tb_jenis_aksesoris WHERE id_jenis_aksesoris = '{$id}'";

$result = mysqli_query( $mysqli, $query); 

foreach( $result as $jenis_aksesoris ) {
   $id = $jenis_aksesoris['id_jenis_aksesoris'];
   $nama = $jenis_aksesoris['nama'];
}
...
<head>
   ...
   <title>Admin - Ubah Jenis Aksesoris</title>
               ...
               <div class="container-fluid">
                  ...
                  <div class="card shadow mb-4">
                        <div class="card-header py-3">
                           <h5 class="m-0 font-weight-bold text-primary">Ubah Data Jenis Aksesoris</h5>
                        </div>
                        <div class="card-body">
                           <div class="p-1">
                              <form action="action_update_accessories.php" method="post">
